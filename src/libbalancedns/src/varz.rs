    ...
    pub fn new() -> Varz {
        Varz {
            ...
            client_queries_offline: register_counter!(opts!(
                "balancedns_client_queries_offline",
