...
func newRuntimeResolver(cfg *config.Config) (runtimeResolver, error) {
	...
	case "recursor", "knot":
		...
		r, err := recursor.NewResolverWithOptions(recursor.Options{
			...
			NSLookupWorkers:        cfg.RecursorNSLookupWorkers,
			MaxNSAddressLookups:    cfg.RecursorMaxNSAddressLookups,
			MaxConcurrentExchanges: cfg.RecursorMaxConcurrentExchanges,
			NSAddrCacheEntries:     cfg.RecursorNSAddrCacheEntries,
			NSPrefetchThreshold:    cfg.RecursorNSPrefetchThreshold,
			NSPrefetchConcurrency:  cfg.RecursorNSPrefetchConcurrency,
			HedgeDelay:             cfg.RecursorHedgeDelay,
			ZoneCutCacheEntries:    cfg.RecursorZoneCutCacheEntries,
		...
		log.Printf(
			...
			cfg.RecursorNSLookupWorkers,
			cfg.RecursorMaxNSAddressLookups,
			cfg.RecursorMaxConcurrentExchanges,
			cfg.RecursorNSAddrCacheEntries,
			cfg.RecursorNSPrefetchThreshold,
			cfg.RecursorNSPrefetchConcurrency,
			cfg.RecursorHedgeDelay,
			cfg.RecursorZoneCutCacheEntries,
			cfg.DNSSECValidate,
