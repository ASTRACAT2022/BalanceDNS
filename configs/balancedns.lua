-- BalanceDNS Lua config example.
-- Use env("NAME", "default") helper to inject environment values.

return {
  listen = {
    dns = env("BALANCEDNS_DNS_ADDR", ":5353"),
    metrics = env("BALANCEDNS_METRICS_ADDR", ":9090"),
